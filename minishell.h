...
t_token							*create_split_commands(t_ms *ms,
									t_token *token);
...
void							handle_builtins(t_ms *ms, int i, int *input_fd,
									int *fd);
void							handle_cd_and_unset(t_ms *ms, int i,
									int *input_fd, int *fd);
void							handle_child_process(t_ms *ms, int i,
									int *input_fd, int *fd);
void							handle_parent_process(t_ms *ms, int i,
									int *input_fd, int *fd);
void							execute_pipe_commands(t_ms *ms, int *input_fd,
									int i);
